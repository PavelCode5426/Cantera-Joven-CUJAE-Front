describe('Comprobar la gestion de los avales', () => {
  ...
  beforeEach('Comprobando la carga de estudiantes', () => {
    ...
    cy.clickElements(['nav-item-cantera', 'nav-item-reportes', 'nav-item-estudiantes-del-area'])
  ...
  it('Crear un aval aleatoriamente', () => {
    cy.getBySel('btn-add-aval').sample().click()
    cy.contains('Crear nuevo Aval')
  })
})
